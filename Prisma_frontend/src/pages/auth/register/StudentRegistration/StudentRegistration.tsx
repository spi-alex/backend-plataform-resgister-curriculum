...
export default function StudentRegistration() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      alert(
        "Erro ao cadastrar. Verifique o código da imagem ou se os dados já existem.",
      );
      await fetchCaptcha();
      setCaptchaValue("");
    }
        ...
        <section className="register-card">
          ...
          <div className="form-grid">
            ...
            <div className="select-group">
              ...
              {errors.situacao && (
                <span className="error">{errors.situacao}</span>
              )}
            </div>
            <Input
              label="Ano de início"
            ...
            {form.situacao === "aluno" && (
              <Input
                ...
                onChange={handleChange}
                error={errors.previsaoConclusao}
              />
            )}
        ...
        <section className="register-card">
          ...
          >
            {captchaData.image_url && (
              <img
                src={`http://127.0.0.1:8000${captchaData.image_url}`}
                alt="captcha"
              />
            )}
            <Input
